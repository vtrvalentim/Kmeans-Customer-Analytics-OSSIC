function [ six_means,stdvall,class_sizes ] = classifier_euclidean_6( clean_data )
...
x3=rand(1,13);
y3=x3/1000;
%initializing fourth, fifth and sixth clusters
starting_p4_2 = starting_p1_2+y1;
starting_p5_2 = starting_p2_2+y2;
starting_p6_2 = starting_p3_2+y3;
...
while i<=row
    ...
    %calculating distance from p5
    while j<=col
       
        add = (clean_data(i,j)- starting_p5_2(1,j))^2;
        sum_p5 = sum_p5+add;
        j=j+1;
    end
    ...
    j=1;
        ...
        %calculating distance from p6
    while j<=col
       
        add = (clean_data(i,j)- starting_p6_2(1,j))^2;
        sum_p6 = sum_p6+add;
        j=j+1;
    end
    ...
    d_euclidean_p5 = sqrt(sum_p5);
    d_euclidean_p6 = sqrt(sum_p6);


    %classifying point according to smallest euclidean distance
    if d_euclidean_p1 < d_euclidean_p2 && d_euclidean_p1 < d_euclidean_p3 && d_euclidean_p1 < d_euclidean_p4 && d_euclidean_p1 < d_euclidean_p5  && d_euclidean_p1 < d_euclidean_p6
        classifier(i,1) = 1;
    elseif d_euclidean_p2 < d_euclidean_p1 && d_euclidean_p2 < d_euclidean_p3 && d_euclidean_p2 < d_euclidean_p4 && d_euclidean_p2 < d_euclidean_p5 && d_euclidean_p2 < d_euclidean_p6
        classifier(i,1) = 2;
    elseif d_euclidean_p3 < d_euclidean_p1 && d_euclidean_p3 < d_euclidean_p2 && d_euclidean_p3 < d_euclidean_p4 && d_euclidean_p3 < d_euclidean_p5 && d_euclidean_p3 < d_euclidean_p6
        classifier(i,1) = 3;
    elseif d_euclidean_p4 < d_euclidean_p1 && d_euclidean_p4 < d_euclidean_p3 && d_euclidean_p4 < d_euclidean_p2 && d_euclidean_p4 < d_euclidean_p5 && d_euclidean_p4 < d_euclidean_p6
        classifier(i,1) = 4;
    elseif d_euclidean_p5 < d_euclidean_p1 && d_euclidean_p5 < d_euclidean_p3 && d_euclidean_p5 < d_euclidean_p2 && d_euclidean_p5 < d_euclidean_p4 && d_euclidean_p5 < d_euclidean_p6
        classifier(i,1) = 5;
    elseif d_euclidean_p6 < d_euclidean_p1 && d_euclidean_p6 < d_euclidean_p2 && d_euclidean_p6 < d_euclidean_p3 && d_euclidean_p6 < d_euclidean_p4 && d_euclidean_p6 < d_euclidean_p5
        classifier(i,1) = 6;
...
while i<=row
    ...
    while j<=col
        ...
        elseif classifier(i,1)==6
            ...
            sum6(1,j)=sum6(1,j)+clean_data(i,j);
        end
...
while i<=row
    ...
    while j<=col
        ...
        add = (clean_data(i,j)- starting_p5_3(1,j))^2;
        sum_p5 = sum_p5+add;
        j=j+1;
    end
    ...
    while j<=col
        ...
        add = (clean_data(i,j)- starting_p6_3(1,j))^2;
        sum_p6 = sum_p6+add;
        j=j+1;
    end
...
while i<=row
    ...
    elseif classifier (i,1)==6
        stdv6=stdv6+(clean_data(i,:)-starting_p6_3)*transpose(clean_data(i,:)-starting_p6_3);
...
stdvall=[stdv1,stdv2,stdv3,stdv4,stdv5,stdv6];

six_means=[starting_p1_3;starting_p2_3;starting_p3_3;starting_p4_3;starting_p5_3;starting_p6_3];

class_sizes=[size1,size2,size3,size4,size5,size6];
